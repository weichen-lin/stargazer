...
func TestToRepositoryEntity(t *testing.T) {
	...
	require.Equal(t, 10, repositoryEntity.StargazersCount)
	require.Equal(t, 20, repositoryEntity.WatchersCount)
	require.Equal(t, 5, repositoryEntity.OpenIssuesCount)
