...
import { GitHubLogoIcon, StarIcon, EyeOpenIcon, CalendarIcon } from '@radix-ui/react-icons'
          ...
          <div className='flex gap-x-1 w-full'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex gap-x-[2px] items-center'>
                ...
                <a
                  className='rounded-full hover:bg-slate-300/30 text-slate-500/75 dark:text-white/70 h-6 px-1'
                  href={owner_url}
                  target='_blank'
                >
                  @{owner_name}
