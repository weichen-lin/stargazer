...
def Crawler(id: int) -> str:
    ...
    if repo.summary_embedding is not None:
        return f"already generate embedding on repo: {id}"
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            summary = pipe(
                article.text_content(), max_length=300, min_length=30, do_sample=False
            )
            ...
            return f"success generate embedding on repo: {id}"
